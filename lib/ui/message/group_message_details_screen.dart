...
class GroupMessageDetailsScreen extends StatelessWidget {
  final ChatGroupRoom groupRoom;

  GroupMessageDetailsScreen({super.key, required this.groupRoom});
    ...
    return Obx(() {
      return Scaffold(
        appBar: AppBar(
          ...
          title: !mdc.isGroupSelectionMode.value && mdc.selectedGroupMessageIds.isEmpty
              ? Row(
                  children: [
                    IconButton(
                      onPressed: () {
                  ...
                  children: [
                    IconButton(
                      onPressed: () {
                        ...
                        mdc.deleteGroupMessageIds.clear();
                      },
                      icon: Icon(Icons.arrow_back_rounded, color: sHeaderColor),
                    ),
                    ...
                    IconButton(
                      onPressed: () {
                        ...
                        showDeleteMessageDialog(
                          ...
                          isMe: true,
                          onDelete: () {
                            mdc.deleteMessage(groupRoom.documentId);
                          },
                        );
                      },
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onLongPress: () {
                                        ...
                                        if (!mdc.isGroupSelectionMode.value) {
                                          mdc.isGroupSelectionMode.value = true;
                                          mdc.selectedGroupMessageIds.add(message.documentId.toString());
                                          if (message.senderId == MessageService().currentUserId) {
                                            mdc.deleteGroupMessageIds.add(message.documentId.toString());
                                          }
                                        }
                                      },
                                      onTap: () {
                                        if (mdc.isGroupSelectionMode.value) {
                                          if (mdc.selectedGroupMessageIds.contains(message.documentId)) {
                                            mdc.selectedGroupMessageIds.remove(message.documentId);
                                            if (mdc.selectedGroupMessageIds.isEmpty) mdc.isGroupSelectionMode.value = false;
                                          } else {
                                            mdc.selectedGroupMessageIds.add(message.documentId.toString());
                                            if (message.senderId == MessageService().currentUserId) {
                                              mdc.deleteGroupMessageIds.add(message.documentId.toString());
                                      ...
                                      child: Stack(
                                        children: [
                                          ...
                                          if (mdc.isGroupSelectionMode.value)
                                            Positioned.fill(
                                              child: Container(
                                                color: mdc.selectedGroupMessageIds.contains(message.documentId)
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: CommonTextFiled(
                            controller: mdc.groupChatBotController.value,
                      ...
                      CommonSvgView(
                        ...
                        fit: BoxFit.cover,
                        onTap: () {
                          mdc.sendMessageInGroup(
                            docId: groupRoom.documentId,
                            messageText: mdc.groupChatBotController.value.text.trim(),
                  ...
                  if (mdc.pikeImageGroupList.isNotEmpty)
                    Container(
                      decoration: BoxDecoration(color: cardColor),
                      child: Row(
                        children: [
                          SizedBox(
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                final bytes = base64Decode(mdc.pikeImageGroupList[index]);
                                return Stack(
                                  children: [
                                    Container(
                                      height: 50.w,
                              ...
                              itemCount: mdc.pikeImageGroupList.length,
                            ),
                          ),
                          SizedBox(width: 10.w),
                          CommonSvgView(
                            ...
                            fit: BoxFit.cover,
                            onTap: () {
                              mdc.sendImageInGroup(groupRoom.documentId);
                            },
                          ),
                        ],
                      ),
